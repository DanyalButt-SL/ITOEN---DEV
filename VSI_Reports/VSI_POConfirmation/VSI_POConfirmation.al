report 50112 "VSI_Standard Purchase - Order"
{
    RDLCLayout = './StandardPurchaseOrder.rdl';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(VendorAdress; "Buy-from Address")
            {
            ...
            column(PurchaseCode; "Purchaser Code")
            {

            }
            dataitem(Comments; "Purch. Comment Line")
            {
                DataItemLink = "No." = FIELD("No."), "Document Type" = FIELD("Document Type");
                DataItemLinkReference = "Purchase Header";
                column(Notes; Comment)
                {
